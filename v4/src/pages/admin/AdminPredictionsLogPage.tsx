...
import { fetchAnonymousPredictions, type PredictionRow } from '@/features/website/services/anonymousPredictionService';
    ...
    <div className="p-4 lg:p-6">
      ...
      {!err && rows !== null && rows.length === 0 && (
        <div className="rounded-lg border border-gray-200 bg-gray-50 py-12 text-center">
          ...
          <p className="text-sm font-semibold text-gray-600">아직 측정 데이터가 없습니다</p>
            ...
            <table className="w-full min-w-[760px] text-sm">
              <thead className="bg-gray-50 text-xs text-gray-500">
                <tr>
                  ...
                  <Th>현재키</Th><Th>예측키</Th><Th>백분위</Th><Th>유입</Th>
                </tr>
              </thead>
