      ...
      {insert && labels.map((l, i) => {
        ...
        return (
          <div
            ...
            className="pointer-events-auto absolute flex max-w-[60%] cursor-move select-none items-center justify-center rounded border border-dashed border-fuchsia-400/90 bg-fuchsia-500/5 px-1.5 py-0.5 text-center text-[10px] font-semibold leading-tight"
            style={{
              left: `${l.x * 100}%`,
