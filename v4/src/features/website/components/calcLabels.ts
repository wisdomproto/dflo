...
export type CalcLang = 'ko' | 'en' | 'th' | 'vi' | 'zh-hant' | 'zh-hans' | 'ar' | 'ja' | 'es';
...
const DICT: Record<CalcLang, Dict> = {
  ...
  ja: {
    ...
    badge: '成長チェック',
    title: 'お子さまの成人身長を予測',
    subtitle: 'いくつか入力するだけで、30秒で予測成人身長がわかります',
    helpButtonAria: 'ヘルプ',
    fieldGender: '性別',
    genderMale: '👦 男の子', genderFemale: '👧 女の子',
    fieldNationality: '国籍',
    natKR: '🇰🇷 韓国', natTH: '🇹🇭 タイ', natCN: '🇨🇳 中国', natUS: '🇺🇸 米国 · 豪州',
    natID: '🇮🇩 インドネシア',
    natWHO: '🌐 WHO（国際）',
    natFooter: {
      KR: '韓国小児成長標準（KDCA 2017）· 5 / 50 / 95 パーセンタイル',
      TH: 'タイ小児成長標準（TSPE 2022）· 5 / 50 / 95 パーセンタイル',
      CN: '中国小児成長基準（近似）· 5 / 50 / 95 パーセンタイル',
      ID: 'インドネシア国家成長基準（INGRC）· 5 / 50 / 95 パーセンタイル',
      US: '米国 CDC 2000 成長曲線 · オーストラリアの国家基準でもある（2〜18歳）· 5 / 50 / 95 パーセンタイル',
      WHO: 'WHO 小児成長標準（2006）+ 成長基準（2007）· 5 / 50 / 95 パーセンタイル',
    },
    fieldBirth: '生年月日',
    fieldBirthYear: '年', fieldBirthMonth: '月', fieldBirthDay: '日',
    fieldHeight: '現在の身長（cm）',
    fieldWeight: '現在の体重（kg）',
    submit: '予測身長を計算',
    submitHint: '性別・生年月日・身長を入力するだけで結果が表示されます',
    helpTitle: '予測のしくみ',
    helpPrincipleH: '📊 方法',
    helpPrincipleP: 'この予測は<strong>各国の標準成長データ</strong>に基づき、同じ年齢・性別の子どもの中でお子さまがどの位置にいるかを分析します。',
    helpAdultH: '🎯 予測成人身長',
    helpAdultP: '同じパーセンタイルを保つと仮定し、同じパーセンタイル上で18歳時点の身長を逆算して成人身長を推定します。',
    helpNoteH: '⚠️ ご注意',
    helpNote1: '骨年齢・成長ホルモン値・栄養状態を反映しない統計的な推定値です。',
    helpNote2: '正確な診断には骨年齢検査と専門医の相談が必要です。',
    helpNote3: '思春期早発症や慢性疾患がある場合、結果は異なることがあります。',
    resultTitle: '予測身長の結果',
    resultLabel: '予測成人身長',
    resultGenderMale: '男の子', resultGenderFemale: '女の子',
    pillAge: (y, m) => `${y}歳 ${m}か月`,
    pillCurrent: (h, p) => `現在 ${h}cm · 上位 ${p.toFixed(1)} パーセンタイル`,
    chartFooter: '韓国小児成長標準（KDCA 2017）· 5 / 50 / 95 パーセンタイル',
    chartXAxis: '年齢（歳）', chartYAxis: '身長（cm）',
    chartPathLegend: '予測される成長曲線',
    interpretH: '📋 見方',
    interpretHigh: '現在、同年代の平均を上回っています。着実な成長ケアで、お子さまの可能性を十分に引き出せます。',
    interpretMid: '現在、同年代の平均あたりです。適切な栄養・運動・睡眠で、成長をさらに後押しできます。',
    interpretLow: '同年代の平均より少し低めです。専門医の相談で成長の余地を確認できます。',
    interpretCritical: '同年代より低めです。成長板が開いている今が、成長ケアのゴールデンタイムです。',
    noteBoxPrincipleLabel: '📊 方法：',
    noteBoxPrincipleBody: '各国の標準成長データに基づき、同年代の中でのお子さまの位置を分析します。',
    noteBoxPredictedLabel: '🎯 予測身長：',
    noteBoxPredictedBody: '同じパーセンタイルを保つと仮定し、同じパーセンタイル上で18歳時点の身長を逆算します。',
    noteBoxCautionLabel: '⚠️ ご注意：',
    noteBoxCautionBody: '骨年齢・成長ホルモン値・栄養を反映しない統計的な推定値です。正確な診断には専門医の相談が必要です。',
    kakaoCta: '💬 1:1相談を受ける',
    ctaContextConcern: 'お子さまは現在、同年代より低めです。成長板が開いている今こそ詳しく見る価値があります。数字だけではわからないことを1:1相談でお伝えします。',
    ctaContextOptimize: 'お子さまは現在、同年代の平均を上回っています。その可能性を最大限に活かすため、数字だけではわからないことを1:1相談でお伝えします。',
    reportSecondary: '📋 まだ相談は早いですか？ まず詳しいレポートを',
    casesLink: '実際の治療事例を見る →',
    reset: 'もう一度測る',
  },
  es: {
    pageTitle: 'Chequeo de estatura gratis',
    badge: 'Evaluación de crecimiento',
    title: 'Prediga la estatura adulta de su hijo/a',
    subtitle: 'Ingrese unos datos y vea la estatura adulta prevista en 30 segundos',
    helpButtonAria: 'Ayuda',
    fieldGender: 'Sexo',
    genderMale: '👦 Niño', genderFemale: '👧 Niña',
    fieldNationality: 'Nacionalidad',
    natKR: '🇰🇷 Corea', natTH: '🇹🇭 Tailandia', natCN: '🇨🇳 China', natUS: '🇺🇸 EE. UU. · Australia',
    natID: '🇮🇩 Indonesia',
    natWHO: '🌐 OMS (internacional)',
    natFooter: {
      KR: 'Estándar de crecimiento pediátrico de Corea (KDCA 2017) · percentiles 5 / 50 / 95',
      TH: 'Estándar de crecimiento pediátrico de Tailandia (TSPE 2022) · percentiles 5 / 50 / 95',
      CN: 'Referencia de crecimiento pediátrico de China (aprox.) · percentiles 5 / 50 / 95',
      ID: 'Referencia nacional de crecimiento de Indonesia (INGRC) · percentiles 5 / 50 / 95',
      US: 'Curvas de crecimiento CDC 2000 de EE. UU. · también la referencia nacional de Australia (2 a 18 años) · percentiles 5 / 50 / 95',
      WHO: 'Estándares de crecimiento infantil de la OMS (2006) + Referencia de crecimiento (2007) · percentiles 5 / 50 / 95',
    },
    fieldBirth: 'Fecha de nacimiento',
    fieldBirthYear: 'Año', fieldBirthMonth: 'Mes', fieldBirthDay: 'Día',
    fieldHeight: 'Estatura actual (cm)',
    fieldWeight: 'Peso actual (kg)',
    submit: 'Calcular estatura prevista',
    submitHint: 'Ingrese sexo, fecha de nacimiento y estatura para ver el resultado',
    helpTitle: 'Cómo funciona la predicción',
    helpPrincipleH: '📊 Método',
    helpPrincipleP: 'Esta predicción se basa en <strong>datos de crecimiento estándar nacionales</strong> y analiza en qué lugar se encuentra su hijo/a entre sus pares de la misma edad y sexo.',
    helpAdultH: '🎯 Estatura adulta prevista',
    helpAdultP: 'Suponiendo que se mantenga en el mismo percentil, calculamos hacia atrás la estatura a los 18 años en ese percentil para estimar la estatura adulta.',
    helpNoteH: '⚠️ Notas',
    helpNote1: 'Es una estimación estadística que no refleja la edad ósea, los niveles de hormona de crecimiento ni el estado nutricional.',
    helpNote2: 'Un diagnóstico preciso requiere una prueba de edad ósea y una consulta con un especialista.',
    helpNote3: 'Los resultados pueden variar en casos de pubertad precoz o enfermedades crónicas.',
    resultTitle: 'Resultado de la estatura prevista',
    resultLabel: 'Estatura adulta prevista',
    resultGenderMale: 'Niño', resultGenderFemale: 'Niña',
    pillAge: (y, m) => `${y} a ${m} m`,
    pillCurrent: (h, p) => `Ahora ${h}cm · percentil ${p.toFixed(1)}`,
    chartFooter: 'Estándar de crecimiento pediátrico de Corea (KDCA 2017) · percentiles 5 / 50 / 95',
    chartXAxis: 'Edad (años)', chartYAxis: 'Estatura (cm)',
    chartPathLegend: 'Trayectoria de crecimiento prevista',
    interpretH: '📋 Interpretación',
    interpretHigh: 'Actualmente por encima del promedio de sus pares. Un cuidado constante del crecimiento puede ayudar a alcanzar todo su potencial.',
    interpretMid: 'Actualmente cerca del promedio de sus pares. Con buena nutrición, ejercicio y sueño, el crecimiento puede apoyarse aún más.',
    interpretLow: 'Algo más bajo que el promedio de sus pares. Una consulta con un especialista puede aclarar el potencial de crecimiento.',
    interpretCritical: 'Más bajo que sus pares: mientras las placas de crecimiento sigan abiertas, esta es la ventana dorada para el cuidado del crecimiento.',
    noteBoxPrincipleLabel: '📊 Método:',
    noteBoxPrincipleBody: 'Basado en datos de crecimiento estándar nacionales, analiza la posición de su hijo/a entre sus pares.',
    noteBoxPredictedLabel: '🎯 Estatura prevista:',
    noteBoxPredictedBody: 'Suponiendo que se mantiene el mismo percentil, se calcula hacia atrás la estatura a los 18 años en ese percentil.',
    noteBoxCautionLabel: '⚠️ Nota:',
    noteBoxCautionBody: 'Una estimación estadística que no refleja la edad ósea, la hormona de crecimiento ni la nutrición. Un diagnóstico preciso requiere una consulta con un especialista.',
    kakaoCta: '💬 Reciba una consulta 1:1',
    ctaContextConcern: 'Su hijo/a está actualmente más bajo que sus pares. Mientras las placas de crecimiento sigan abiertas, vale la pena mirarlo de cerca: una consulta 1:1 muestra lo que el número por sí solo no dice.',
    ctaContextOptimize: 'Su hijo/a está actualmente por encima del promedio. Para aprovechar al máximo ese potencial, una consulta 1:1 muestra lo que el número por sí solo no dice.',
    reportSecondary: '📋 ¿Aún no quiere hablar? Reciba primero un informe detallado',
    casesLink: 'Ver casos reales de tratamiento →',
    reset: 'Medir de nuevo',
  },
