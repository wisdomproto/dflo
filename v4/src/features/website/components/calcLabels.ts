...
type Dict = {
  ...
  helpLmsH: string;        helpLmsP: string;
...
const DICT: Record<CalcLang, Dict> = {
  ko: {
    ...
    helpPrincipleP: '본 예상키 계산은 <strong>한국 질병관리청(2017)</strong>에서 발표한 소아·청소년 성장 표준 데이터(LMS 방법)를 기반으로 합니다.',
    helpLmsH: '📐 LMS 방법이란?',
    helpLmsP: '세계보건기구(WHO)가 권장하는 통계 기법으로, 같은 나이·성별 아이들의 키 분포를 L(왜도), M(중앙값), S(변동계수) 세 가지 파라미터로 모델링합니다.',
    ...
    noteBoxPrincipleBody: '한국 질병관리청(2017) 소아·청소년 성장 표준 데이터(LMS 방법) 기반',
  ...
  en: {
    ...
    helpPrincipleP: 'This prediction is based on <strong>Korea CDC (2017)</strong> pediatric & adolescent growth standards using the LMS method.',
    helpLmsH: '📐 What is the LMS method?',
    helpLmsP: 'A statistical technique recommended by the WHO that models the height distribution of children of the same age and sex with three parameters: L (skewness), M (median), and S (coefficient of variation).',
    ...
    noteBoxPrincipleBody: 'Based on Korea CDC (2017) pediatric & adolescent growth standards (LMS method).',
  ...
  th: {
    ...
    helpPrincipleP: 'การคำนวณนี้อ้างอิงจาก <strong>ข้อมูลมาตรฐานการเจริญเติบโตของเด็กและวัยรุ่นเกาหลี (KDCA 2017)</strong> โดยใช้วิธี LMS',
    helpLmsH: '📐 วิธี LMS คืออะไร?',
    helpLmsP: 'เทคนิคทางสถิติที่ WHO แนะนำ โดยจำลองการกระจายของส่วนสูงในเด็กที่อายุและเพศเดียวกันด้วยพารามิเตอร์ 3 ตัว ได้แก่ L (ความเบ้), M (ค่ามัธยฐาน) และ S (ค่าสัมประสิทธิ์ความแปรปรวน)',
    ...
    chartFooter: 'มาตรฐานการเจริญเติบโตเด็กเกาหลี (KDCA 2017) · เปอร์เซ็นไทล์ที่ 5 / 50 / 95',
    ...
    noteBoxPrincipleBody: 'อ้างอิงข้อมูลมาตรฐานการเจริญเติบโตเด็กเกาหลี KDCA 2017 (วิธี LMS)',
  ...
  vi: {
    ...
    helpPrincipleP: 'Tính toán này dựa trên <strong>chuẩn tăng trưởng nhi khoa & thanh thiếu niên Hàn Quốc (KDCA 2017)</strong> theo phương pháp LMS.',
    helpLmsH: '📐 Phương pháp LMS là gì?',
    helpLmsP: 'Kỹ thuật thống kê do WHO khuyến nghị, mô hình hóa phân bố chiều cao của trẻ cùng tuổi và giới tính bằng ba tham số: L (độ lệch), M (trung vị), S (hệ số biến thiên).',
    ...
    noteBoxPrincipleBody: 'Dựa trên chuẩn tăng trưởng nhi Hàn Quốc KDCA 2017 (phương pháp LMS).',
