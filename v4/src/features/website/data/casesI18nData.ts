...
export type CaseLocale = 'en' | 'th' | 'vi' | 'zh-hant' | 'zh-hans';
...
const FOOD: Record<string, LocalizedString> = {
  '우유':         { en: 'Milk', th: 'นม', vi: 'Sữa', 'zh-hant': '牛奶', 'zh-hans': '牛奶' },
  '카제인':       { en: 'Casein', th: 'เคซีน', vi: 'Casein', 'zh-hant': '酪蛋白', 'zh-hans': '酪蛋白' },
  '요그르트':     { en: 'Yogurt', th: 'โยเกิร์ต', vi: 'Sữa chua', 'zh-hant': '優格', 'zh-hans': '酸奶' },
  '치즈':         { en: 'Cheese', th: 'ชีส', vi: 'Phô mai', 'zh-hant': '起司', 'zh-hans': '奶酪' },
  '계란흰자':     { en: 'Egg white', th: 'ไข่ขาว', vi: 'Lòng trắng trứng', 'zh-hant': '蛋白', 'zh-hans': '蛋清' },
  '계란 흰자':    { en: 'Egg white', th: 'ไข่ขาว', vi: 'Lòng trắng trứng', 'zh-hant': '蛋白', 'zh-hans': '蛋清' },
  '계란 노른자':  { en: 'Egg yolk', th: 'ไข่แดง', vi: 'Lòng đỏ trứng', 'zh-hant': '蛋黃', 'zh-hans': '蛋黄' },
  '파인애플':     { en: 'Pineapple', th: 'สับปะรด', vi: 'Dứa', 'zh-hant': '鳳梨', 'zh-hans': '菠萝' },
  '마늘':         { en: 'Garlic', th: 'กระเทียม', vi: 'Tỏi', 'zh-hant': '大蒜', 'zh-hans': '大蒜' },
  '대두콩':       { en: 'Soybean', th: 'ถั่วเหลือง', vi: 'Đậu nành', 'zh-hant': '大豆', 'zh-hans': '大豆' },
  '아몬드':       { en: 'Almond', th: 'อัลมอนด์', vi: 'Hạnh nhân', 'zh-hant': '杏仁', 'zh-hans': '杏仁' },
  '캐슈넛':       { en: 'Cashew', th: 'มะม่วงหิมพานต์', vi: 'Hạt điều', 'zh-hant': '腰果', 'zh-hans': '腰果' },
  '캐슈 너트':    { en: 'Cashew', th: 'มะม่วงหิมพานต์', vi: 'Hạt điều', 'zh-hant': '腰果', 'zh-hans': '腰果' },
  '염소우유':     { en: 'Goat milk', th: 'นมแพะ', vi: 'Sữa dê', 'zh-hant': '山羊奶', 'zh-hans': '山羊奶' },
  '양우유':       { en: 'Sheep milk', th: 'นมแกะ', vi: 'Sữa cừu', 'zh-hant': '綿羊奶', 'zh-hans': '绵羊奶' },
  '에스파게트':   { en: 'Spaghetti', th: 'สปาเกตตี', vi: 'Spaghetti', 'zh-hant': '義大利麵', 'zh-hans': '意大利面' },
  '미역':         { en: 'Wakame seaweed', th: 'สาหร่ายวากาเมะ', vi: 'Rong biển wakame', 'zh-hant': '裙帶菜', 'zh-hans': '裙带菜' },
  '잉어':         { en: 'Carp', th: 'ปลาคาร์ป', vi: 'Cá chép', 'zh-hant': '鯉魚', 'zh-hans': '鲤鱼' },
  '대구':         { en: 'Cod', th: 'ปลาคอด', vi: 'Cá tuyết', 'zh-hant': '鱈魚', 'zh-hans': '鳕鱼' },
  '먹도미류':     { en: 'Black bream', th: 'ปลาทรายแดงดำ', vi: 'Cá tráp đen', 'zh-hant': '黑鯛', 'zh-hans': '黑鲷' },
  '참돔':         { en: 'Red sea bream', th: 'ปลาทรายแดง', vi: 'Cá tráp đỏ', 'zh-hant': '真鯛', 'zh-hans': '真鲷' },
  '장어':         { en: 'Eel', th: 'ปลาไหล', vi: 'Lươn', 'zh-hant': '鰻魚', 'zh-hans': '鳗鱼' },
  '해덕':         { en: 'Haddock', th: 'ปลาแฮดด็อก', vi: 'Cá tuyết chấm đen', 'zh-hant': '黑線鱈', 'zh-hans': '黑线鳕' },
  '퍼츠':         { en: 'Perch', th: 'ปลาเพิร์ช', vi: 'Cá pecca', 'zh-hant': '河鱸', 'zh-hans': '河鲈' },
  '강꼬치고기':   { en: 'Pike', th: 'ปลาไพค์', vi: 'Cá chó', 'zh-hant': '梭子魚', 'zh-hans': '梭子鱼' },
  '연어':         { en: 'Salmon', th: 'ปลาแซลมอน', vi: 'Cá hồi', 'zh-hant': '鮭魚', 'zh-hans': '三文鱼' },
  '각시서대속 어류': { en: 'Sole', th: 'ปลาลิ้นหมา', vi: 'Cá bơn lưỡi', 'zh-hant': '鰨魚', 'zh-hans': '鳎鱼' },
  '송어':         { en: 'Trout', th: 'ปลาเทราต์', vi: 'Cá hồi vân', 'zh-hant': '鱒魚', 'zh-hans': '鳟鱼' },
  '잠치':         { en: 'Sandfish', th: 'ปลาหินทราย', vi: 'Cá cát', 'zh-hant': '沙魚', 'zh-hans': '沙鱼' },
  '가자미류':     { en: 'Flounder', th: 'ปลาตาเดียว', vi: 'Cá bơn', 'zh-hant': '比目魚', 'zh-hans': '比目鱼' },
  '오렌지':       { en: 'Orange', th: 'ส้ม', vi: 'Cam', 'zh-hant': '柳橙', 'zh-hans': '橙子' },
  '자두':         { en: 'Plum', th: 'พลัม', vi: 'Mận', 'zh-hant': '李子', 'zh-hans': '李子' },
  '보리':         { en: 'Barley', th: 'ข้าวบาร์เลย์', vi: 'Lúa mạch', 'zh-hant': '大麥', 'zh-hans': '大麦' },
  '마카로니용 밀':{ en: 'Durum wheat', th: 'ข้าวสาลีดูรัม', vi: 'Lúa mì durum', 'zh-hant': '杜蘭小麥', 'zh-hans': '杜兰小麦' },
  '글리아딘':     { en: 'Gliadin', th: 'กลีอะดิน', vi: 'Gliadin', 'zh-hant': '麥膠蛋白', 'zh-hans': '麦胶蛋白' },
  '엿기름':       { en: 'Malt', th: 'มอลต์', vi: 'Mạch nha', 'zh-hant': '麥芽', 'zh-hans': '麦芽' },
  '귀리':         { en: 'Oats', th: 'โอ๊ต', vi: 'Yến mạch', 'zh-hant': '燕麥', 'zh-hans': '燕麦' },
  '호밀가루':     { en: 'Rye flour', th: 'แป้งไรย์', vi: 'Bột lúa mạch đen', 'zh-hant': '黑麥麵粉', 'zh-hans': '黑麦面粉' },
  '스펠트밀':     { en: 'Spelt', th: 'สเปลต์', vi: 'Lúa mì spelt', 'zh-hant': '斯佩爾特小麥', 'zh-hans': '斯佩尔特小麦' },
  '밀':           { en: 'Wheat', th: 'ข้าวสาลี', vi: 'Lúa mì', 'zh-hant': '小麥', 'zh-hans': '小麦' },
  '밀 겨':        { en: 'Wheat bran', th: 'รำข้าวสาลี', vi: 'Cám lúa mì', 'zh-hant': '麥麩', 'zh-hans': '麦麸' },
  '옥수수':       { en: 'Corn', th: 'ข้าวโพด', vi: 'Ngô', 'zh-hant': '玉米', 'zh-hans': '玉米' },
  '쌀':           { en: 'Rice', th: 'ข้าว', vi: 'Gạo', 'zh-hant': '稻米', 'zh-hans': '大米' },
  '겨자 씨':      { en: 'Mustard seed', th: 'เมล็ดมัสตาร์ด', vi: 'Hạt mù tạt', 'zh-hant': '芥末籽', 'zh-hans': '芥末籽' },
  '소고기':       { en: 'Beef', th: 'เนื้อวัว', vi: 'Thịt bò', 'zh-hant': '牛肉', 'zh-hans': '牛肉' },
  '양고기':       { en: 'Lamb', th: 'เนื้อแกะ', vi: 'Thịt cừu', 'zh-hant': '羊肉', 'zh-hans': '羊肉' },
  '타조고기':     { en: 'Ostrich', th: 'เนื้อนกกระจอกเทศ', vi: 'Thịt đà điểu', 'zh-hant': '鴕鳥肉', 'zh-hans': '鸵鸟肉' },
  '광고기':       { en: 'Pollock', th: 'ปลาพอลล็อก', vi: 'Cá pollock', 'zh-hant': '明太魚', 'zh-hans': '明太鱼' },
  '토끼':         { en: 'Rabbit', th: 'กระต่าย', vi: 'Thỏ', 'zh-hant': '兔肉', 'zh-hans': '兔肉' },
  '사슴고기':     { en: 'Venison', th: 'เนื้อกวาง', vi: 'Thịt nai', 'zh-hant': '鹿肉', 'zh-hans': '鹿肉' },
  '멧돼지':       { en: 'Wild boar', th: 'หมูป่า', vi: 'Lợn rừng', 'zh-hant': '野豬肉', 'zh-hans': '野猪肉' },
  '브라질호두':   { en: 'Brazil nut', th: 'บราซิลนัท', vi: 'Hạt Brazil', 'zh-hant': '巴西堅果', 'zh-hans': '巴西坚果' },
  '헤이즐넛':     { en: 'Hazelnut', th: 'เฮเซลนัท', vi: 'Quả phỉ', 'zh-hant': '榛果', 'zh-hans': '榛子' },
  '땅콩':         { en: 'Peanut', th: 'ถั่วลิสง', vi: 'Đậu phộng', 'zh-hant': '花生', 'zh-hans': '花生' },
  '피스타치오':   { en: 'Pistachio', th: 'พิสตาชิโอ', vi: 'Hạt dẻ cười', 'zh-hant': '開心果', 'zh-hans': '开心果' },
  '알파락트알부민':{ en: 'Alpha-lactalbumin', th: 'อัลฟา-แลคตาลบูมิน', vi: 'Alpha-lactalbumin', 'zh-hant': 'α-乳白蛋白', 'zh-hans': 'α-乳白蛋白' },
  '농어':         { en: 'Sea bass', th: 'ปลากะพง', vi: 'Cá vược', 'zh-hant': '鱸魚', 'zh-hans': '鲈鱼' },
  '고등어':       { en: 'Mackerel', th: 'ปลาแมคเคอเรล', vi: 'Cá thu', 'zh-hant': '鯖魚', 'zh-hans': '鲭鱼' },
  '아귀':         { en: 'Monkfish', th: 'ปลามังก์ฟิช', vi: 'Cá lưỡi rồng', 'zh-hant': '鮟鱇魚', 'zh-hans': '鮟鱇鱼' },
  '고동':         { en: 'Conch', th: 'หอยสังข์', vi: 'Ốc xà cừ', 'zh-hant': '海螺', 'zh-hans': '海螺' },
  '석류':         { en: 'Pomegranate', th: 'ทับทิม', vi: 'Lựu', 'zh-hant': '石榴', 'zh-hans': '石榴' },
  '아마란스':     { en: 'Amaranth', th: 'อะมารันท์', vi: 'Rau dền', 'zh-hant': '莧菜', 'zh-hans': '苋菜' },
  '말고기':       { en: 'Horse meat', th: 'เนื้อม้า', vi: 'Thịt ngựa', 'zh-hant': '馬肉', 'zh-hans': '马肉' },
  '호두':         { en: 'Walnut', th: 'วอลนัท', vi: 'Quả óc chó', 'zh-hant': '核桃', 'zh-hans': '核桃' },
  '무우':         { en: 'Radish', th: 'หัวไชเท้า', vi: 'Củ cải trắng', 'zh-hant': '白蘿蔔', 'zh-hans': '白萝卜' },
  '버섯':         { en: 'Mushroom', th: 'เห็ด', vi: 'Nấm', 'zh-hant': '蘑菇', 'zh-hans': '蘑菇' },
};
...
export const CASES_I18N: Record<string, CaseI18nOverride> = {
  ...
  'case-8fp1vfmj': {
    ...
    intakeInfo: {
      desiredHeight: { en: 'Over 180 cm', th: 'มากกว่า 180 ซม.', vi: 'Trên 180 cm', 'zh-hant': '180 公分以上', 'zh-hans': '180 厘米以上' },
      growthConcerns: {
  ...
  'case-zjg7a85h': {
    ...
    intakeInfo: {
      desiredHeight: { en: '185 cm', th: '185 ซม.', vi: '185 cm', 'zh-hant': '185 公分', 'zh-hans': '185 厘米' },
      growthConcerns: {
  ...
  'case-6jk8vtuo': {
    ...
    intakeInfo: {
      desiredHeight: { en: '183 cm', th: '183 ซม.', vi: '183 cm', 'zh-hant': '183 公分', 'zh-hans': '183 厘米' },
      growthConcerns: {
  ...
  'case-ublb7r61': {
    ...
    intakeInfo: {
      desiredHeight: { en: '165 cm', th: '165 ซม.', vi: '165 cm', 'zh-hant': '165 公分', 'zh-hans': '165 厘米' },
      growthConcerns: {
  ...
  'case-3200315i': {
    ...
    intakeInfo: {
      desiredHeight: { en: '182 cm', th: '182 ซม.', vi: '182 cm', 'zh-hant': '182 公分', 'zh-hans': '182 厘米' },
      growthConcerns: {
