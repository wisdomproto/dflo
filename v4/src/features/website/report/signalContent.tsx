...
export const SIGNAL_CONTENT: Record<BlockId, SignalBlock> = {
  sleep: {
    ...
    help: (
      <>
        수면 습관을 <b>문진으로 자세히 점검</b>하고, 숙면을 방해하는 원인(비염·아데노이드 등)을 찾아
        아이에게 맞는 <b>맞춤형 처방</b>과 수면 습관 관리를 진행합니다.
      </>
    ),
  },
  ...
  puberty: {
    ...
    help: (
      <>
        <b>뼈나이 X-ray와 진찰</b>로 사춘기 단계와 성장판 잔여 시간을 정확히 평가해, 지금 아이에게
        필요한 맞춤 관리를 안내합니다.
      </>
    ),
  },
  ...
  obesity: {
    ...
    help: (
      <>
        키·체중으로 <b>BMI</b>를 확인하고 뼈나이로 사춘기 진행 정도를 평가해, 아이에게 맞는 체중·식이
        맞춤 관리를 안내합니다.
      </>
    ),
  },
  ...
  growthVelocity: {
    ...
    help: (
      <>
        성장 곡선을 추적하고 뼈나이로 남은 성장 여력을 확인해, 성장 지연이 의심되면 <b>원인 감별
        검사(성장호르몬·갑상선 등)</b>로 정밀하게 살핍니다.
      </>
    ),
  },
