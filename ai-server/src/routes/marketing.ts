...
// ── meta (Meta 연결 + 발행) ────────────────────────────────────────────────
// GET /meta/connection — 토큰 제외 연결 요약
marketingRouter.get('/meta/connection', async (_req, res) => {
  try {
...
// DELETE /meta/connection — 연결 해제
marketingRouter.delete('/meta/connection', async (_req, res) => {
  try {
