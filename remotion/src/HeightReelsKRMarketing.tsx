// KR marketing reel — 5 cuts (brand/trust funnel, video-driven):
// 1 인트로(intro.mp4) → 2 원장·병원 소개 → 3 통합 치료(growingup.mp4)
// → 4 셀럽 아역(celeb-reel.mp4) → 5 CTA(홈페이지 예측키 무료 측정 안내)
// 나레이션(Gemini TTS, Kore)을 씬별로 1.3배속으로 깔아 길이를 맞춘다.
