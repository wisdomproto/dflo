...
// 키 크는 식단 피라미드 — PresenterShort(원장 정면 베이스 + 인포그래픽 인서트 + 인트로/CTA). 마케팅 콘텐츠 #22.
...
// KO (원장 모국어, 클론음성)
export const DIETPYRAMID_KO_DURATION = presenterDuration(tKo);
export const DietPyramidKO = mkFinal("ko", tKo);
