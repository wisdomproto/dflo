...
// 키 막는 숨은 적, 중금속 — PresenterShort(원장 정면 베이스 + 인포그래픽 인서트 + 인트로/CTA). 마케팅 콘텐츠 #17.
...
// KO (원장 모국어, 클론음성)
export const HEAVYMETAL_KO_DURATION = presenterDuration(tKo);
export const HeavyMetalKO = mkFinal("ko", tKo);
