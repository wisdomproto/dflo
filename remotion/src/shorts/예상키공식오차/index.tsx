...
// 부모 키 공식의 함정 — PresenterShort(원장 정면 베이스 + 인포그래픽 인서트 + 인트로/CTA). 마케팅 콘텐츠 #6.
...
// KO (원장 모국어, 클론음성)
export const HEIGHTFORMULA_KO_DURATION = presenterDuration(tKo);
export const HeightFormulaKO = mkFinal("ko", tKo);
