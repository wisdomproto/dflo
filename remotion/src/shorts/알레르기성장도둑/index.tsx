...
// 알레르기·만성염증 성장 도둑 — PresenterShort(원장 정면 베이스 + 인포그래픽 인서트 + 인트로/CTA). 마케팅 콘텐츠 #15.
...
// KO (원장 모국어, 클론음성)
export const ALLERGYTHIEF_KO_DURATION = presenterDuration(tKo);
export const AllergyThiefKO = mkFinal("ko", tKo);
