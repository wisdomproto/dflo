...
// 엑스레이 한 장으로 미래 키가 보인다 — 뼈나이 — PresenterShort(원장 정면 베이스 + 인포그래픽 인서트 + 인트로/CTA). 마케팅 콘텐츠 #5.
...
// KO (원장 모국어, 클론음성)
export const BONEXRAY_KO_DURATION = presenterDuration(tKo);
export const BoneXrayKO = mkFinal("ko", tKo);
