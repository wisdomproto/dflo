...
// 채소 몰래 먹이는 기술 7가지 — PresenterShort(원장 정면 베이스 + 인포그래픽 인서트 + 인트로/CTA). 마케팅 콘텐츠 #29.
...
// KO (원장 모국어, 클론음성)
export const HIDEVEGGIES_KO_DURATION = presenterDuration(tKo);
export const HideVeggiesKO = mkFinal("ko", tKo);
