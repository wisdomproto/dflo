...
// 성장호르몬 10시 신화의 진실 — PresenterShort(원장 정면 베이스 + 인포그래픽 인서트 + 인트로/CTA). 마케팅 콘텐츠 #4.
...
// KO (원장 모국어, 클론음성)
export const GH10_KO_DURATION = presenterDuration(tKo);
export const Gh10KO = mkFinal("ko", tKo);
