...
// 칼슘만 먹으면 새는 이유 — 비타민D — PresenterShort(원장 정면 베이스 + 인포그래픽 인서트 + 인트로/CTA). 마케팅 콘텐츠 #28.
...
// KO (원장 모국어, 클론음성)
export const CALCIUMVITD_KO_DURATION = presenterDuration(tKo);
export const CalciumVitDKO = mkFinal("ko", tKo);
