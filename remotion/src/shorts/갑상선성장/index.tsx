...
// 키를 멈추는 숨은 사령관, 갑상선 — PresenterShort(원장 정면 베이스 + 인포그래픽 인서트 + 인트로/CTA). 마케팅 콘텐츠 #14.
...
// KO (원장 모국어, 클론음성)
export const THYROID_KO_DURATION = presenterDuration(tKo);
export const ThyroidKO = mkFinal("ko", tKo);
