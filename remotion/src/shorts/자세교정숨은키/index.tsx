...
// 구부정해서 작아 보이는 키 — 자세 교정 — PresenterShort(원장 정면 베이스 + 인포그래픽 인서트 + 인트로/CTA). 마케팅 콘텐츠 #31.
...
// KO (원장 모국어, 클론음성)
export const POSTURE_KO_DURATION = presenterDuration(tKo);
export const PostureKO = mkFinal("ko", tKo);
