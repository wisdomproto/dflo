...
// 키 크는 운동, 나이마다 다르다 — PresenterShort(원장 정면 베이스 + 인포그래픽 인서트 + 인트로/CTA). 마케팅 콘텐츠 #26.
...
// KO (원장 모국어, 클론음성)
export const AGEEXERCISE_KO_DURATION = presenterDuration(tKo);
export const AgeExerciseKO = mkFinal("ko", tKo);
