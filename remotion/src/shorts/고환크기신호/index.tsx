...
// 남자아이 사춘기 첫 신호 — PresenterShort(원장 정면 베이스 + 인포그래픽 인서트 + 인트로/CTA). 마케팅 콘텐츠 #11.
...
// KO (원장 모국어, 클론음성)
export const TESTISSIGN_KO_DURATION = presenterDuration(tKo);
export const TestisSignKO = mkFinal("ko", tKo);
