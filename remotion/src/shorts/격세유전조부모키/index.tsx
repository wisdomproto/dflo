...
// 조부모 키와 격세유전 — PresenterShort(원장 정면 베이스 + 인포그래픽 인서트 + 인트로/CTA). 마케팅 콘텐츠 #7.
...
// KO (원장 모국어, 클론음성)
export const GRANDPARENTS_KO_DURATION = presenterDuration(tKo);
export const GrandparentsKO = mkFinal("ko", tKo);
