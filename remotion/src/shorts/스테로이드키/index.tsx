...
// 스테로이드 약과 키 — 흡입·연고·경구 — PresenterShort(원장 정면 베이스 + 인포그래픽 인서트 + 인트로/CTA). 마케팅 콘텐츠 #19.
...
// KO (원장 모국어, 클론음성)
export const STEROID_KO_DURATION = presenterDuration(tKo);
export const SteroidKO = mkFinal("ko", tKo);
