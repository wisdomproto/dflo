...
// 스트레스가 키를 막는다 — 코르티솔 — PresenterShort(원장 정면 베이스 + 인포그래픽 인서트 + 인트로/CTA). 마케팅 콘텐츠 #12.
...
// KO (원장 모국어, 클론음성)
export const CORTISOL_KO_DURATION = presenterDuration(tKo);
export const CortisolKO = mkFinal("ko", tKo);
