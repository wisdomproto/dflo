...
// 아침 커튼부터 — 키 크는 수면 스위치 — PresenterShort(원장 정면 베이스 + 인포그래픽 인서트 + 인트로/CTA). 마케팅 콘텐츠 #24.
...
// KO (원장 모국어, 클론음성)
export const SLEEPROUTINE_KO_DURATION = presenterDuration(tKo);
export const SleepRoutineKO = mkFinal("ko", tKo);
